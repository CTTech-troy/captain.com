...
export function Navigation() {
  ...
  return (
    <header
      ...
      <nav aria-label="Primary" className="container-page flex h-16 items-center justify-between gap-6 md:h-[72px]">
        <BrandLogo />
            ...
            return (
              <li key={link.label}>
                <Link
                  ...
                  className={cn(
                    'relative block whitespace-nowrap px-3 py-2 text-[14px] font-medium transition-colors duration-200',
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border border-line bg-white text-ink transition-colors duration-200 hover:border-forest-800 lg:hidden">
