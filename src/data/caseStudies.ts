...
export const caseStudies: CaseStudy[] = [
{
  ...
  solution: 'Captain.com shaped a customer-facing marketplace experience built around searchable inventory, brand and category browsing, shipping destination guidance, and clear lead capture that turns interest into dealership conversations.',
  ...
  image: '/img1.png',
  imageAlt: 'Captain.com landing page and system mockup shown in the supplied image',
...
},
{
  ...
  solution: 'Captain.com designed a newsroom experience built for live updates, topic-driven navigation, and clear audience engagement across breaking, business, technology, world, sports, and AI coverage.',
  ...
  image: '/img2.png',
  imageAlt: 'Anchor News editorial and publishing design reference',
...
},
{
  ...
  solution: 'Captain.com designed a cleaner, more credible logistics-facing web experience that sharpens the brand story, strengthens trust signals, and helps prospective clients understand the company’s offer more quickly.',
  ...
  image: '/img3.png',
  imageAlt: 'Brij logistics brand representation',
